function [P,S_P,F,Tt4,pi_c_total] = PW120model(Mach,altitude)

x = [    0.1005    0.0302    0.0813    0.0392    0.9950    0.9950    0.8205    0.8472    0.8618    0.9048    0.8867    0.9778    0.9551    0.9778   10.2874    7.4729    0.6277    0.5567    0.4873    0.6588    0.6000]

h = altitude;          % Altitude - [ft]
M0 = Mach;     % Mach number
