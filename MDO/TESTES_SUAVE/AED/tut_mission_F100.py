...
def main():
    ...
    print_weight_breakdown(configs.base,filename = 'F100_weight_breakdown.dat')

    # print engine data into file
    print_engine_data(configs.base,filename = 'F100_engine_data.dat')
    ...
    print_parasite_drag(ref_condition,configs.cruise,analyses,'F100_parasite_drag.dat')

    # print compressibility drag data into file
    print_compress_drag(configs.cruise,analyses,filename = 'F100_compress_drag.dat')

    # print mission breakdown
    print_mission_breakdown(results,filename='F100_mission_breakdown.dat')
