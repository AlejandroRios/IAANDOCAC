function [areawingwet, xutip, yutip, xltip, yltip,...
...
%
function areawet=calcareawet(xistosXper,xistosYper,xistosZper)
...
%--------------------------------------------------------------------------
function Stri=tri3darea(x1,y1,z1,x2,y2,z2,x3,y3,z3)
