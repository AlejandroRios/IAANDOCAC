...
ht4p1 = (mdot4*ht4+epsilon1*ht3)/(mdot4+epsilon1);% Typo in mattingly?
[~, ~, Prt4p1, ~, ~, ~, ~, ~] = FAIR(2, f4p1, [], ht4p1);
T_t4p5 = Tt4_5_R;
while true % Label 1
    ...
    [~, ht4p4i, ~, ~, ~, ~, ~, ~] = FAIR(3, f4p1, [],[], Prt4p4i);
    ht4p4 = ht4p1-eta_tH*(ht4p1-ht4p4i);
    Tau_tH = ht4p4/ht4p1;
    ht4p5 = (mdot4p1*ht4p4+epsilon2*ht3)/(mdot4p1+epsilon2);
    [Tt4p5n, ~, ~, ~, ~, ~, ~, ~] = FAIR(2, f4p5, [], ht4p5);
