function [P_S_kW,P_eq_kW,F_jet_net,BSFC_shaft,BSFC_eq,m_dot_a,m_dot_e,m_dot_f,f,M_e,TR ]  = Turboprop_func(mode,b,Tmax,M0,h)
...
d_e = 0.328;         % core nozzle fixed exit diameter 
