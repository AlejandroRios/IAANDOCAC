...
clc
%%
global P0 T05 P05 eta_t eta_n gamma_t gamma_n R_air 
...
T8 = T06*(P0/P07)^((gamma_n-1)/gamma_n);

M_e = V_e/sqrt(gamma_n*R_air*T8);

rho8 = P0*1000/(R_air*T8);
rho_e = rho8;
m_dot_e = rho_e*V_e*A_e;

P_S_m_dot_a = Cp_t*eta_m*(T05-T06);
