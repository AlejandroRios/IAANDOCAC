...
% x = [0.2530    0.3002    0.0876    0.0100    0.9824    0.9903    0.8666    0.8416    0.9061    1.0000    1.0000    0.8097 0.5290    0.0561    0.1261]

x = [0         0    0.0699    0.0238    0.9938    0.9794    0.8328    0.8746    0.8682    1.0000    1.0000    0.9692    0.4527 0.0276    0.6443    2.8202]
...
% =========================================================================
% Others
m0_dot = x(16);   % Mass flow rate - [kg/s]
% =========================================================================
% Execution:
% =========================================================================
...
[P_m0_dot,F,P,m0_dot,S,S_P,f0,eta_P,eta_TH,eta_O,C_c,C_prop,...
