...
% Design limitations:
    ...
    epsilon1 = 0.0998;     % Cooling air #1 mass flow rate
    epsilon2 = 0.0561;     % Cooling air #2 mass flow rate

    % Total pressure ratio:
    pi_b = 0.97;        % Burner
    pi_dmax = 0.922;     % Inlet/Difusser
    pi_n = 0.925;        % Nozzle
    
    % Polytropic efficiency:
    e_c = 0.8776;      % Compressor
    e_tH = 0.8569;    % High pressure turbine
    e_tL = 0.8218;    % Low pressure turbine
    ...
    eta_prop = 0.9063;        % Proppeler
    eta_g = 0.98;           % Gearbox
% =========================================================================
% Design choices: 
pi_c = 12.1;      % Total pressure ratio compressor
tau_t = 0.5334;      % Total enthalpy ratio of turbine
