%{
Title     : Turboprop off-design performance
Written by: Alejandro Rios
Date      : March 2020
Language  : Matlab
Reference : Aircraft Engine Design - Mattingly et al.
Aeronautical Institute of Technology
Inputs: 
Tt4, Tt3 limit, pi_c limit, M0, altitude 

Outputs:
F_m0_dot, F, S, pi_c

NOTE: More outputs available if needed
%}
...
pi_d_max = 0.95;            % Diffuser or inlet total pressure ratio
pi_b = 0.94;                % Burner total pressure ratio
pi_n = 0.95;                % Exhaust nozzle total pressure ratio

% Efficiencies eta's:
eta_c = 0.85;             % Adiabatic efficiency of compressor
eta_tH = 0.8950;            % Adiabatic efficiency of high pressure turbine
eta_tL = 0.88;            % Adiabatic efficiency of low pressure turbine
eta_b = 0.99;              % Adiabatic efficiency of burner
eta_mL = 0.98;              % Adiabatic efficiency of mechanical low pressure spool
eta_mH = 0.98;              % Adiabatic efficiency of mechanical high pressure spool
eta_mPL = 0.98;                % Adiabatic efficiency of mechanical pwr takeoff shaft from low pressure spool
eta_mPH = 0.98;                % Adiabatic efficiency of mechanical pwr takeoff shaft from high pressure spool
...
h_PR = 42800000*JKg2BTUlbm ;                                       % [Btu/lbm]
P_TOL = 0;                                          % [kW]
P_TOH = 0;                                          % [kW]
...
% Component behavior:
pi_c_R = 7.2;                % Total pressure ratio accros the compressor
...
pi_c_max = 30;              % Max total pressure ratio across the compressor
Tt3_max = 1600;                                     % [R]
Pt3_max = 0;
N_L_percent = 100;                                  % [%]
N_H_percent = 100;                                  % [%]
...
% SFC
S_P = (f0/(C_TOTAL*h0/2544.5));                                     % [(lbm/hr)/HP]
