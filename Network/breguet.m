...
%               'Jet'/'Range' only for finding R and for 'Prop'/'Range'
%               only for finding E.
...
%   constant over the entire flight segment.
% 
%   BREGUET is fully vectorized and also can accept dimensioned variables
%   using the DimVar class (see UNITS function). This is extemely helpful
%   in enforcing unit consistency and eliminating common errors.
% 
...
%   Copyright 2012-2015 Sky Sartorius
